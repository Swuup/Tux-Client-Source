package tk.tuxclient.gui.account;
...
public class TuxPassword extends Gui
{
    private final int id;
    private final TuxFontRenderer fontRendererInstance;
    ...
    public TuxPassword(int componentId, TuxFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
                ...
                default:
                    if (ChatAllowedCharacters.isAllowedCharacter(p_146201_1_))
                    {
                        if (this.isEnabled)
                        {
                            ...
                            this.password = this.password + p_146201_1_;
                        }
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                TuxDrawUtils.drawBorderedRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 10, 1, Color.LIGHT_GRAY.getRGB(),-16777216);
            }
