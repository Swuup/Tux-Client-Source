...
public class TuxEnabledCosmeticButton extends GuiButton {

    protected boolean hovered;
    public Cosmetic currentMod;

    public TuxEnabledCosmeticButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, Cosmetic mod) {
    ...
    public TuxEnabledCosmeticButton(int buttonId, int x, int y, String buttonText) { this(buttonId, x, y, 100, 20, buttonText, null); }
