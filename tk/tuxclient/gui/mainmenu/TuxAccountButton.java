...
public class TuxAccountButton extends GuiButton {

    protected boolean hovered;

    public TuxAccountButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
    ...
    public TuxAccountButton(int buttonId, int x, int y, String buttonText) { this(buttonId, x, y, 20, 20, buttonText); }
    ...
    public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
        if (this.enabled)
        {
            ...
            Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("tux/icon/account.png"));
