...
public class TuxEnabledButton extends GuiButton {

    protected boolean hovered;
    public Mod currentMod;

    public TuxEnabledButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, Mod mod) {
    ...
    public TuxEnabledButton(int buttonId, int x, int y, String buttonText) { this(buttonId, x, y, 100, 20, buttonText, null); }
