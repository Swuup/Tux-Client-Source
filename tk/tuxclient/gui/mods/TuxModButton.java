...
public class TuxModButton extends GuiButton {

    protected boolean hovered;

    public TuxModButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
    ...
    public TuxModButton(int buttonId, int x, int y, String buttonText) { this(buttonId, x, y, 100, 20, buttonText); }
