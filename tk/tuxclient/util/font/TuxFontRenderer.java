...
public final class TuxFontRenderer extends TuxFont {

    protected final TuxFont.CharData[] boldItalicChars = new TuxFont.CharData[256];
    protected final TuxFont.CharData[] italicChars = new TuxFont.CharData[256];
    protected final TuxFont.CharData[] boldChars = new TuxFont.CharData[256];
    ...
    public TuxFontRenderer(ResourceLocation resourceLocation, float size) {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {   	
        ...
        TuxFont.CharData[] currentData = this.charData;
