...
import tk.tuxclient.mods.impl.togglesprintsneak.Movement;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
            ...
            while (Mouse.next())
            {
                ...
                if (i1 <= 200L)
                {
                    ...
                    if (j != 0)
                    {
                        ...
                        {
                            if (!Config.zoomMode || !ModInstances.getModZoom().isEnabled()) {
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            this.thePlayer.movementInput = new Movement(this.gameSettings);
