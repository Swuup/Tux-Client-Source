...
public class GameSettings
{
    ...
    public KeyBinding modKeyBind = new KeyBinding("Mod Settings", Keyboard.KEY_RSHIFT, "Tux Client");
    ...
    private void addKeybinds() {
        this.keyBindings = ((KeyBinding[])ArrayUtils.add(this.keyBindings, this.modKeyBind));
    }
